...
public class PhysicsClass12ChapterActivity extends AppCompatActivity {
    private String As01 = "",
            As02 = "",
            As03 = "",
            As04 = "",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physics_class12_chapter);
        ...
        progressDialog = new ProgressDialog ( PhysicsClass12ChapterActivity.this);
        ...
        im1.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent ( PhysicsClass12ChapterActivity.this,pdfviewerActivity.class );
    ...
    private void RetriveYouserInfo() {
        ...
        progressDialog.show ();
        RootRef.child ( "Class12" ).child("Physics").child ( "Study" )
                .addValueEventListener ( new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        ...
                        Toast.makeText ( PhysicsClass12ChapterActivity.this, "Error.", Toast.LENGTH_SHORT ).show ();
                        progressDialog.dismiss ();
                    }
                } );
    }
